...
// import { AiOutlineGlobal, AiOutlineIdcard, AiOutlineEnvironment, AiOutlineCheckCircle, AiOutlineAim, AiOutlineSelect, AiOutlineZoomIn, AiOutlineDrag, AiOutlineClose } from 'react-icons/ai';
